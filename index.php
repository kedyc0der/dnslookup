...
<html lang="en">
    <head>
        <!-- Kedy.Coder Dns Lookup Php Script -->
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            ...
            <div class="row marketing">
                ...
                <h4>Direct link : <a href="<?=htmlspecialchars($page_url_domain)?>"><?=htmlspecialchars($page_url_domain)?></a></h4>
                ...
                <table class="table table-striped table-bordered table-responsive">
                    <thead class="bg-primary">
                        <tr>
                            ...
                            <th>Entries for <?=htmlspecialchars($domain)?></th>
                        </tr>
                    </thead>
            ...
            <footer class="footer">
                <p  class="text-center"> Simple DNS Lookup - <a href="https://github.com/kedyc0der/">Sourcecode on GitHub</a></p>
            </footer>
            </div> <!-- /container -->
    </body>
</html>
